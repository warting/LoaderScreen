...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void setUpView(Toolbar toolbar, NavigationView navigationView) {
    ...
    public static void navigateUpOrBack(Activity currentActivity) {
        ...
        if (intent == null) {
            intent = NavUtils.getParentActivityIntent(currentActivity);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            ...
            createBackStack(new Intent(this, ToolsActivity.class));
        }
